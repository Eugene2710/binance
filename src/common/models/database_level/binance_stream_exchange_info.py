...
class TickerStreamDTO(BaseModel):
    ...
    @staticmethod
    def from_stream_exchange_info(
        input: BinanceStreamedExchangeInfo,
    ) -> "TickerStreamDTO":
...
if __name__ == "__main__":
    sample_exchange_info: BinanceStreamedExchangeInfo = BinanceStreamedExchangeInfo(
        e="24hrMiniTicker",
        E=1754491665009,
        s="REDFDUSD",
        c="0.38750000",
    ...
    ticker_stream_dto: TickerStreamDTO = TickerStreamDTO.from_stream_exchange_info(
